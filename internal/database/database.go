...
// for authorized user in GophKeeper storage.
...
// provided authorized user from GophKeeper storage.
...
// UpdateNote is a method for updating note content for authorized user in GophKeeper storage.
...
// Login is a method for login user in GophKeeper system with provided login and password.
// User logins are stored in the GophKeeper database as bcrypt hashes.
...
// Register is a method for register new user in GophKeeper storage with provided credentials.
